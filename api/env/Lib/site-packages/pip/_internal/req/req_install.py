...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # gets stored. We need this to pass to build_wheel, so the api
        ...
        # The PEP 517 api we should use to build the project
    ...
    def prepare_metadata(self):
        ...
        Under PEP 517, call the api hook to prepare the metadata.

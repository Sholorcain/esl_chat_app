...
.. versionchanged:: 1.0.0 - :class:`.Table` reflection now includes
   ...
   collection; the PostgreSQL api will no longer include a "mirrored"
...
The :class:`.Inspector` used for the PostgreSQL api is an instance
...
The combination of ENUM and ARRAY is not directly supported by api
...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum):
    ...
    True, the PostgreSQL api will use a :class:`.postgresql.ENUM`

...
class CreateColumn(_DDLCompiles):
    ...
    api, but on other backends does render it, in anticipation of a
    ...
    will be omitted, but only against the PostgreSQL api.
        ...
        try:
            ...
            if not self.dialect.supports_alter:
                util.warn(
                    ...
                    "dependency exists between tables: %s, and api does "

...
class HasPrefixes(object):
    ...
    def prefix_with(self, *expr, **kw):
        ...
        This is used to support api-specific prefix keywords such as those
        provided by MySQL.
...
class HasSuffixes(object):
    ...
    def suffix_with(self, *expr, **kw):
        ...
        This is used to support api-specific suffix keywords on
        certain constructs.
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def with_statement_hint(self, text, dialect_name='*'):
        ...
        Hints here are specific to the api database and may include
    ...
    def with_hint(self, selectable, text, dialect_name='*'):
        ...
        location for the database api in use, relative
        ...
        hint to a particular api. Such as, to add hints for both Oracle

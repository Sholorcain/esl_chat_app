...
class UpdateBase(
    ...
    def with_hint(self, text, selectable=None, dialect_name="*"):
        ...
        hint to a particular api. Such as, to add a hint
...
class ValuesBase(UpdateBase):
    ...
    def return_defaults(self, *cols):
        ...
        When used against a api that supports RETURNING, all column
        ...
        3. It can be called against any api.  Backends that don't support

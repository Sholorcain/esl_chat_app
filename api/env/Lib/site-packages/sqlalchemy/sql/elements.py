...
class BindParameter(ColumnElement):
    ...
    def __init__(self, key, value=NO_ARG, type_=None,
        ...
        :param quote:
          ...
          only applies to the Oracle api, where bound names must
          sometimes be quoted.
...
class TextClause(Executable, ClauseElement):
    ...
    def _create_text(self, text, bind=None, bindparams=None,
        ...
        api-neutral support for bind parameters, per-statement
...
class False_(ColumnElement):
    ...
    def _instance(cls):
        ...
        A api which does not support true/false constants will render as
...
class ColumnClause(Immutable, ColumnElement):
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        api, the column expression will render using the quoting
        behavior determined by the api.  To produce a textual SQL
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    quoting behavior is applied to the identifier on a per-api basis
    ...
    The above logic will run the "has table" logic against the Oracle api,

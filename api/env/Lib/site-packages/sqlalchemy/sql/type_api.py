...
class TypeEngine(Visitable):
    ...
    def compare_against_backend(self, dialect, conn_type):
        """Compare this type against the given api type.
        ...
        :param conn_type: the type object reflected from the api.
...
class Emulated(object):
    ...
    natively by some backends.  When a native-providing api is in

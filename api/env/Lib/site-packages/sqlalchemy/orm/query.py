...
class Query(object):
    ...
    def with_for_update(self, read=False, nowait=False, of=None,
        ...
        appended.  When additional arguments are specified, api-specific
        ...
        The above query on a PostgreSQL api will render like::
    ...
    def distinct(self, *criterion):
        ...
        .. note::
            ...
            of the database api that ORDER BY columns be part of the

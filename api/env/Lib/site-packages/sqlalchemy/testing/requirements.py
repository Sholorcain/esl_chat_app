...
class SuiteRequirements(Requirements):
    ...
    def binary_literals(self):
        """target api supports simple binary literals, e.g. an
        expression like::
    ...
    def precision_numerics_general(self):
        """target api has general support for moderately high-precision
        numerics."""
        return exclusions.open()

    @property
    def precision_numerics_enotation_small(self):
        """target api supports Decimal() objects using E notation
    ...
    def precision_numerics_many_significant_digits(self):
        """target api supports values with many digits on both sides,
    ...
    def precision_generic_float_type(self):
        """target api will return native floating point numbers with at
    ...
    def floats_to_four_decimals(self):
        """target api can return a floating-point number with four
    ...
    def fetch_null_from_numeric(self):
        """target api doesn't crash when you try to select a NUMERIC
    ...
    def percent_schema_names(self):
        """target api supports weird identifiers with percent signs
    ...
    def order_by_label_with_expression(self):
        """target api supports ORDER BY a column label within an
        expression.
